...
namespace reshade
{
	...
	public:
		...
		int mouse_movement_delta_x() const { return _mouse_raw_delta[0] != 0 ? _mouse_raw_delta[0] : _mouse_position[0] - _last_mouse_position[0]; }
		int mouse_movement_delta_y() const { return _mouse_raw_delta[1] != 0 ? _mouse_raw_delta[1] : _mouse_position[1] - _last_mouse_position[1]; }
